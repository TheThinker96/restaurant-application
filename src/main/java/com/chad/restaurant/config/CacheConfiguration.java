package com.chad.restaurant.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.chad.restaurant.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.chad.restaurant.repository.UserRepository.USERS_BY_EMAIL_CACHE);
