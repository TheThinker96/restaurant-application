...
import com.chad.restaurant.repository.SectionRepository;
import com.chad.restaurant.service.SectionService;
...
/**
 * REST controller for managing {@link com.chad.restaurant.domain.Section}.
 */
@RestController
@RequestMapping("/api")
public class SectionResource {
     ...
     */
    @GetMapping("/sections")
    public ResponseEntity<List<SectionDTO>> getAllSections(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
