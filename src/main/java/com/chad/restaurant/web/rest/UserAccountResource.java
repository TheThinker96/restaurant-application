...
/**
 * REST controller for managing {@link com.chad.restaurant.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    public ResponseEntity<List<UserAccountDTO>> getAllUserAccounts(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
