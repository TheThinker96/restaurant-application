...
import com.chad.restaurant.repository.ProduitRepository;
import com.chad.restaurant.service.dto.ProduitDTO;
import com.chad.restaurant.service.mapper.ProduitMapper;
...
class ProduitResourceIT {
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getPrice()).isEqualByComparingTo(DEFAULT_PRICE);
    }
    ...
    void putExistingProduit() throws Exception {
        ...
        assertThat(testProduit.getPrice()).isEqualByComparingTo(UPDATED_PRICE);
    }
