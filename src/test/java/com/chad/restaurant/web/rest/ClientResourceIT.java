...
import com.chad.restaurant.repository.ClientRepository;
import com.chad.restaurant.service.dto.ClientDTO;
import com.chad.restaurant.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).sexe(DEFAULT_SEXE).telephone(DEFAULT_TELEPHONE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).sexe(UPDATED_SEXE).telephone(UPDATED_TELEPHONE);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).sexe(UPDATED_SEXE).telephone(UPDATED_TELEPHONE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).sexe(UPDATED_SEXE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).sexe(UPDATED_SEXE).telephone(UPDATED_TELEPHONE);
